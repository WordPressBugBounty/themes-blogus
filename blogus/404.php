...
get_header(); ?>
  ...
  <!--container--> 
    <!--row-->
    <div class="row">
      <?php if(get_theme_mod('enable_pages_bcrumb',true)) { do_action('blogus_breadcrumb_content'); } ?>
      <!--container-->
      <div class="col-lg-12 text-center bs-section"> 
        <!--mg-error-404-->
        <div class="bs-error-404">
          <h1><?php esc_html_e('4','blogus'); ?><i class="fas fa-ban"></i><?php esc_html_e('4','blogus'); ?></h1>
