...
$wp_customize->add_section( 'post_image_options' , array(
    'title' => __('Post Image Settings', 'blogus'),
    'capability' => 'edit_theme_options',
    'panel' => 'theme_option_panel',
    'priority' => 85,
) );
...
$wp_customize->add_control(
    new blogus_Section_Title(
        ...
        array(
            ...
            'section'           => 'site_post_date_author_settings',
            'active_callback'   => 'content_layout_status',
        )
    )
);
...
$wp_customize->add_setting( 'post_image_type', array(
    'default'           => $blogus_default['post_image_type'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'blogus_sanitize_select',
) );
$wp_customize->add_control( 'post_image_type', array(
    'type'     => 'radio',
    'label'    => esc_html__( 'Post Image Display Type:', 'blogus' ),
    'choices'  => array(
        'post_fix_height'          => esc_html__( 'Fix Height Post Image', 'blogus' ),
        'post_auto_height' => esc_html__( 'Auto Height Post Image', 'blogus' ),
    ),
...
$wp_customize->add_control(
    new blogus_Custom_Radio_Default_Image_Control( 
        ...
        array(
            ...
            'section'       => 'general_options',
            'choices'       => array(
                'fas fa-angle-up' => get_template_directory_uri() . '/images/fu1.svg',
                'fas fa-angle-double-up'    => get_template_directory_uri() . '/images/fu2.svg',
                'fas fa-arrow-up'    => get_template_directory_uri() . '/images/fu3.svg',
...
$wp_customize->add_setting(
    'blogus_footer_text_color',
    array( 
        'sanitize_callback' => 'blogus_sanitize_alpha_color',
        'default' => $blogus_default['blogus_footer_text_color'],
        'transport'         => 'postMessage',
    ) 
);
...
$wp_customize->add_setting(
    'blogus_footer_copy_bg', 
    array( 
        'sanitize_callback' => 'sanitize_hex_color',
        'default' => $blogus_default['blogus_footer_copy_bg'],
        'transport'=> 'postMessage',
    ) 
); 
...
$wp_customize->add_setting(
    'blogus_footer_copy_text', 
    array( 
        'sanitize_callback' => 'sanitize_hex_color',
        'default' => $blogus_default['blogus_footer_copy_text'],
        'transport'=> 'postMessage',
    ) 
); 
